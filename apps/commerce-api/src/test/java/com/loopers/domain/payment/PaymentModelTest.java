...
class PaymentModelTest {
  ...
  @DisplayName("주문 번호가 존재하지 않는 다면, `NoSuchElementException`을 발생시킨다.")
  @Test
  ...
  @DisplayName("계정 아이디가 존재하지 않는 다면, `NoSuchElementException`을 발생시킨다.")
  @Test
  void throwIllegalArgumentException_WhenNotExitsUserId() {
    //given
